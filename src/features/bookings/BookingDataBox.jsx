    ...
    <StyledBookingDataBox>
      <Header>
        <div>
          <HiOutlineHomeModern />
          <p>
            {numNights} noites na cabine <span>{cabinName}</span>
          </p>
        </div>
      ...
      <Section>
        <Guest>
          {countryFlag && (
            <Flag src={countryFlag} alt={`Bandeira de ${country}`} />
          )}
          <p>
            {guestName} {numGuests > 1 ? `+ ${numGuests - 1} convidados` : ""}
          </p>
          <span>&bull;</span>
          <p>{email}</p>
          <span>&bull;</span>
        ...
        <DataItem icon={<HiOutlineCheckCircle />} label="Café da manhã incluso?">
